...
$upload_dir = '/sigesco/public/sisgeof/source/'.$user.'/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../source/'.$user.'/'; // relative path from filemanager folder to upload folder (with final /)
